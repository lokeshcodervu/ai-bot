...
const INITIAL_PLANS_DATA: Record<string, PlanData> = {
  free: {
    id: 'free',
    ...
    maxCampaigns: 1,
    maxCalls: 100,
    freeTierPerks: ['1 Free AI Voice', '1 Campaign slot', '100 Free Call Minutes', 'Community Email Support'],
    features: ['1 AI Voice access', '1 Active Campaign', '100 Included Call Minutes', 'Basic Call Logs & Dashboard'],
    isPopular: false,
    isActive: true
  },
  basic: {
    ...
    maxCampaigns: 5,
    maxCalls: 1500,
    freeTierPerks: ['2 AI Voices included', '5 Active Campaigns', '1,500 Call Minutes/mo'],
    features: ['2 AI Voice Clones', '5 Simultaneous Campaigns', '1,500 Included Minutes', 'Email & Chat Support'],
    isPopular: false,
    isActive: true
  },
  pro: {
    ...
    maxCampaigns: 25,
    maxCalls: 10000,
    freeTierPerks: ['5 Premium AI Voices', '25 Campaigns', '10,000 Call Minutes/mo', 'Priority Support & Live Monitor'],
    features: ['5 High Quality AI Voices', 'Unlimited Campaigns', '10,000 Included Minutes', 'Real-time Live Audio Monitoring', 'Priority 24/7 Support'],
    isPopular: true,
    isActive: true
  },
  enterprise: {
    ...
    maxCampaigns: 100,
    maxCalls: 50000,
    freeTierPerks: ['Custom Voice Cloning', 'Unlimited Campaigns', '50,000 Call Minutes/mo', 'Dedicated Account Manager'],
    features: ['All AI Voices & Custom Cloning', 'Unlimited Campaigns', '50,000 Included Minutes', 'Dedicated Account Manager', 'SSO & SLA Guarantees'],
    isPopular: false,
    isActive: true
  }
};
...
export default function EditSubscriptionPlanPage() {
  ...
  const planId = (params?.id as string) || 'pro';

  const [name, setName] = useState('');
  const [price, setPrice] = useState('');
  const [billingCycle, setBillingCycle] = useState<'monthly' | 'yearly'>('monthly');
  const [maxVoices, setMaxVoices] = useState<number>(5);
  const [maxCampaigns, setMaxCampaigns] = useState<number>(25);
  const [maxCalls, setMaxCalls] = useState<number>(10000);
  ...
  useEffect(() => {
    const defaultData = INITIAL_PLANS_DATA[planId] || {
      id: planId,
      ...
      maxCampaigns: 25,
      maxCalls: 10000,
      freeTierPerks: ['5 Premium AI Voices', '10,000 Call Minutes/mo'],
      features: ['5 AI Voices', 'Priority 24/7 Support'],
    ...
    setBillingCycle(defaultData.billingCycle);
    setMaxVoices(defaultData.maxVoices);
    setMaxCampaigns(defaultData.maxCampaigns);
    setMaxCalls(defaultData.maxCalls);
    setPerks(defaultData.freeTierPerks);
    setFeatures(defaultData.features);
    setIsActive(defaultData.isActive);
    setIsPopular(defaultData.isPopular);
  }, [planId]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Subscription plan '${name.trim()}' updated successfully! Redirecting to plans list.`);
  ...
  return (
    <div className="space-y-6 text-slate-800 animate-fade-in font-outfit p-2 md:p-4 max-w-5xl mx-auto">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="page-header-title">
              Edit Plan: {name || planId}
            </h1>
            <p className="light-text mt-0.5">
              Super Admin: Update plan pricing, limits, free perks, and feature highlights.
            </p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* SECTION 1: PLAN IDENTITY & PRICING */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:border-slate-400"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:outline-none focus:border-slate-400"
                />
        ...
        {/* SECTION 2: CLICKABLE PLAN RESOURCE LIMITS */}
